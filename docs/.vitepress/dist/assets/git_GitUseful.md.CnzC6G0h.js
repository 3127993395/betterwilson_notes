import{_ as s,c as i,o as a,a1 as n}from"./chunks/framework.DCKU21so.js";const l="/assets/bg2015120901.Cr03_EwX.png",E=JSON.parse('{"title":"常用 Git 命令清单","description":"","frontmatter":{},"headers":[],"relativePath":"git/GitUseful.md","filePath":"git/GitUseful.md"}'),h={name:"git/GitUseful.md"},p=n('<h1 id="常用-git-命令清单" tabindex="-1">常用 Git 命令清单 <a class="header-anchor" href="#常用-git-命令清单" aria-label="Permalink to &quot;常用 Git 命令清单&quot;">​</a></h1><p><img src="'+l+`" alt="img"></p><ul><li>Workspace：工作区</li><li>Index / Stage：暂存区</li><li>Repository：仓库区（或本地仓库）</li><li>Remote：远程仓库</li></ul><h2 id="新建代码库" tabindex="-1">新建代码库 <a class="header-anchor" href="#新建代码库" aria-label="Permalink to &quot;新建代码库&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 在当前目录新建一个Git代码库</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">$</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> archive</span></span></code></pre></div>`,26),k=[p];function t(e,F,g,r,d,y){return a(),i("div",null,k)}const C=s(h,[["render",t]]);export{E as __pageData,C as default};
